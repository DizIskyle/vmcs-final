...
<table class="table table-bordered responsive nowrap" id="example" width="100%">
	<thead> 
		<tr>
			...
			<th width="5%">date_sched</th>
			<th width="5%">pet_id</th>
...
$(document).ready(function() {
    ...
    var dataTable = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "pages_exe/sys_admin/manage_appointment_exe_dt.php",
            type: "POST"
        }
    });
    ...
    function submitForm() {
        ...
        $.ajax({
            type: 'POST',
            url: 'pages_exe/sys_admin/manage_appointment_exe_crud.php',
            data: data,
