            ...
            <div class="col-xs-10 col-sm-10 col-md-4 col-lg-4  col-xs-offset-1 col-sm-offset-1 col-md-offset-4 pallet">
                <form class="form-login" method="POST" id="login-form">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center" >
                        ...
                        <p style="padding-top: 0px; margin-top: 0px;">Reset your Password</p>
                        <p style="padding-top: 0px; margin-top: 0px;">Enter the your new password. Strong password include numbers, letters, and punctuation marks. </p>
                        <br> 
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            <label for="">Enter your password one more time</label>
                            <input type="password" class="form-control" placeholder="Confirm Password" name="user_password" id="user_password" />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
